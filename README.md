...
[![Release](https://img.shields.io/github/v/release/thecloudsolutions/terraform-aws-acm-component?style=for-the-badge&color=6150E8)](https://github.com/thecloudsolutions/terraform-aws-acm-component/releases)
[![Commit](https://img.shields.io/github/last-commit/thecloudsolutions/terraform-aws-acm-component?style=for-the-badge&color=FF9800)](https://github.com/thecloudsolutions/terraform-aws-acm-component/commits)
[![Issues](https://img.shields.io/github/issues/thecloudsolutions/terraform-aws-acm-component?style=for-the-badge&color=BB019E)](https://github.com/thecloudsolutions/terraform-aws-acm-component/issues)
...
[![License](https://img.shields.io/github/license/thecloudsolutions/terraform-aws-acm-component?style=for-the-badge&color=3FB950)](https://github.com/thecloudsolutions/terraform-aws-acm-component/blob/main/LICENSE)

# terraform-aws-acm-component
...
A Terraform component that creates and manages AWS Certificate Manager certificates. Supports DNS and email validation, certificate import, and automatic renewal for ACM-managed certificates.
...
```hcl
module "terraform-aws-acm-component" {
  source = "thecloudsolutions/terraform-aws-acm-component"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_acm"></a> [acm](#module\_acm) | thecloudsolutions/terraform-aws-units-internal.git//acm | main |

## Inputs

| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| <a name="input_acm_map"></a> [acm\_map](#input\_acm\_map) | Keyed collection of acm definitions | <pre>map(object({<br/>    certificate = optional(object({<br/>      domain_name               = string<br/>      validation_method         = string<br/>      subject_alternative_names = optional(list(string))<br/><br/>      options = optional(object({<br/>        certificate_transparency_logging_preference = string<br/>      }))<br/><br/>      tags = optional(map(string))<br/>    }))<br/><br/>    certificate_validation = optional(object({<br/>      certificate_arn         = optional(string)<br/>      region                  = optional(string)<br/>      validation_record_fqdns = optional(list(string))<br/><br/>      timeouts = optional(object({<br/>        create = string<br/>      }))<br/>    }))<br/>  }))</pre> | n/a | yes |
